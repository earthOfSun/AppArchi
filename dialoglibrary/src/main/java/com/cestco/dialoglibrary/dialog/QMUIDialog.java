...
package com.cestco.dialoglibrary.dialog;
...
import com.cestco.dialoglibrary.R;
import com.cestco.dialoglibrary.util.QMUIDisplayHelper;
import com.cestco.dialoglibrary.util.QMUILangHelper;
import com.cestco.dialoglibrary.util.QMUIResHelper;
import com.cestco.dialoglibrary.widget.QMUISpanTouchFixTextView;
import com.cestco.dialoglibrary.widget.QMUIWrapContentScrollView;
...
//            mCheckMarkDrawable = QMUIResHelper.getAttrDrawable(context, R.attr.qmui_s_checkbox);
            mCheckMarkDrawable = context.getResources().getDrawable(R.drawable.qmui_s_checkbox);
        }
